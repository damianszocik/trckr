  ...
  return (
   <ResponsiveContainer width="100%" aspect={this.props.mini ? 3 : isMobile ? 1.5 : 3}>
    <LineChart data={chartDataArray}>
     ...
     {!this.props.mini && <Tooltip labelFormatter={value => `${new Date(value).toLocaleDateString()} ${new Date(value).toLocaleTimeString()}`} formatter={value => `${value}${this.props.unit || ''}`} />}
