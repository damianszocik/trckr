...
import { Modal, Icon, Card, Spin, Row, Col, Statistic, Typography } from 'antd';
                  ...
                  <Col span={24}>
                    <Card bodyStyle={trackerData.options.trackerType == 'binary' ? { padding: 'auto' } : { paddingLeft: 0, paddingBottom: 0 }}>
                      {trackerData.options.trackerType == 'binary' ? (
                        <BinaryTrackerCalendar calendarData={trackerData.data} icons={trackerData.options.binaryIcons} />
                      ) : (
